...
- **Маршрут с учётом тени**: для заданной точки назначения ранжирует
  ...
  расстоянию).
- **Ведение по маршруту**: бот сам предлагает включить геолокацию; синяя
  точка на карте двигается вместе с человеком, кнопка «🧭 Вести по маршруту»
  показывает, сколько осталось идти, предупреждает, если человек свернул не
  туда, и сообщает «Вы на месте».
